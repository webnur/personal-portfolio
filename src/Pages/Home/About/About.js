        ...
        <div className='container mx-auto py-16' id='about'>
            ...
            <div className="hero bg-base-200 p-6">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <PhotoProvider>
                        <PhotoView src="https://scontent.fcgp25-1.fna.fbcdn.net/v/t1.6435-9/137309703_2858857814404049_2259188380411779180_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=YnlYVLWPfugAX9GpB1u&_nc_ht=scontent.fcgp25-1.fna&oh=00_AfBeigMuG37pXEmNFHu99dCvq0Emhz_lzqbu-NZ7rdK_LA&oe=63BBEE13">
